...
void Camera::Matrix(const float& FOVdeg, const float& nearPlane, const float& farPlane, const Shader& shader, const char* uniform)
{
	...
	//std::cout << "coords " << Position.x << " " << Position.y << " " << Position.z << std::endl;
